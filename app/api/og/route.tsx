...
export async function GET(request: Request) {
  try {
    ...
    const description = hasDescription
      ...
      : "xeloraCRM is an open source CRM build on top of NextJS. Technology stack: NextJS with Typescrtipt, MongoDB, TailwindCSS, React, Prisma, shadCN, resend.com, react.email and more. ";
